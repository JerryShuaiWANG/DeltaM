...
try:
    ...
    # from . import RDKitUtil
    import docopt
    import MiscUtil
    import RDKitUtil
    # docopt_jl = imp.load_compiled('docopt_jl', 'dp')
    # docopt = docopt_jl.docopt
    # MiscUtil = imp.load_compiled('MiscUtil', 'mu')
    # RDKitUtil = imp.load_compiled('RDKitUtil', 'rku')
...
def RetrieveMolecularDescriptorsInfo(PrintInfo = True):
    ...
    DescriptorsInfo = Descriptors._descList
...
def RetrieveOptions(options=None):
    """Retrieve command line arguments and options"""
